...
<span className="bg-clip-text text-transparent bg-gradient-to-r from-[#2b7bff] via-[#7dd3fc] to-[#8b5cf6]">Portfolio</span>
</h2>


<p className="text-slate-600 text-sm md:text-base max-w-xl mx-auto">
A curated showcase of our latest work — beautiful interfaces, fast delivery and measurable business impact.
</p>
