...
// import ProjectThreeImg from "../../../assets/project-three.png";
...
<div className="absolute bottom-3 left-3 inline-flex items-center gap-2 bg-white/80 backdrop-blur-md rounded-full px-2 py-1 text-xs font-medium shadow">
Map
</div>
...
<h3 className="text-lg font-semibold text-slate-900">Project Three</h3>
<p className="text-sm text-slate-500 mt-1">Real Estate · Listing Platform</p>


<div className="mt-3 flex items-center justify-center gap-2">
<span className="inline-block text-xs font-medium px-2 py-1 rounded-full bg-slate-100 text-slate-700">Map Integration</span>
<span className="inline-block text-xs font-medium px-2 py-1 rounded-full bg-slate-100 text-slate-700">Performance</span>
</div>
</div>
</article>
);
